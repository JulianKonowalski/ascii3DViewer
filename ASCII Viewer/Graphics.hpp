...
namespace graphics {
	...
	void rasteriseMesh(const Mesh& mesh, const drawMeshMode& mode, const Vec3& lightDirection, const int& screenWidth, const int& screenHeight, const int& FOV, std::string& buffer); //insert mesh into buffer
